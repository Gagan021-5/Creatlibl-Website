...
const Hero = () => {
  return (
    <>
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold mb-4 pb-2 bg-gradient-to-b from-neutral-200 to-neutral-400 bg-clip-text text-transparent text-center">
        ...
        <div className="flex justify-center max-sm:flex-col gap-4">
          <button className="bg-gradient-to-r from-sky-800 to-black/60 text-white hover:shadow shadow-lg shadow-gray-800  px-6 py-3 cursor-pointer rounded-lg font-semibold hover:bg-zinc-900">
